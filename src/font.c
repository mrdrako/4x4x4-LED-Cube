...
void scroll_string_y(const char* mystring, int delay, int level)
{
    ...
    for (y = 0; y < size; y++)
    {
        set_y_line_pattern(3, level, cubesize, 0);  //cube[level][3] = cube[level][2];
        set_y_line_pattern(2, level, cubesize, 0);  //cube[level][2] = cube[level][1];
        set_y_line_pattern(1, level, cubesize, 0);  //cube[level][1] = cube[level][0];
        set_y_line_pattern(0, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][0]));  //cube[level][0] = pgm_read_byte(&font[(((int)mystring[y])-32)][0]);
        delay_ms(delay);
        set_y_line_pattern(3, level, cubesize, 0);  //cube[level][3] = cube[level][2];
        set_y_line_pattern(2, level, cubesize, 0);  //cube[level][2] = cube[level][1];
        set_y_line_pattern(1, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][0]));  //cube[level][1] = pgm_read_byte(&font[(((int)mystring[y])-32)][0]);
        set_y_line_pattern(0, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][1]));  //cube[level][0] = pgm_read_byte(&font[(((int)mystring[y])-32)][1]);
        delay_ms(delay);
        set_y_line_pattern(3, level, cubesize, 0);  //cube[level][3] = cube[level][2];
        set_y_line_pattern(2, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][0]));  //cube[level][2] = pgm_read_byte(&font[(((int)mystring[y])-32)][0]);
        set_y_line_pattern(1, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][1]));  //cube[level][1] = pgm_read_byte(&font[(((int)mystring[y])-32)][1]);
        set_y_line_pattern(0, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][2]));  //cube[level][0] = pgm_read_byte(&font[(((int)mystring[y])-32)][2]);
        delay_ms(delay);
        set_y_line_pattern(3, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][0]));  //cube[level][3] = pgm_read_byte(&font[(((int)mystring[y])-32)][0]);
        set_y_line_pattern(2, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][1]));  //cube[level][2] = pgm_read_byte(&font[(((int)mystring[y])-32)][1]);
        set_y_line_pattern(1, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][2]));  //cube[level][1] = pgm_read_byte(&font[(((int)mystring[y])-32)][2]);
        set_y_line_pattern(0, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][3]));  //cube[level][0] = pgm_read_byte(&font[(((int)mystring[y])-32)][3]);
        delay_ms(delay);
        set_y_line_pattern(3, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][1]));  //cube[level][3] = pgm_read_byte(&font[(((int)mystring[y])-32)][1]);
        set_y_line_pattern(2, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][2]));  //cube[level][2] = pgm_read_byte(&font[(((int)mystring[y])-32)][2]);
        set_y_line_pattern(1, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][3]));  //cube[level][1] = pgm_read_byte(&font[(((int)mystring[y])-32)][3]);
        set_y_line_pattern(0, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][4]));  //cube[level][0] = pgm_read_byte(&font[(((int)mystring[y])-32)][4]);
        delay_ms(delay);
        set_y_line_pattern(3, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][2]));  //cube[level][3] = pgm_read_byte(&font[(((int)mystring[y])-32)][2]);
        set_y_line_pattern(2, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][3]));  //cube[level][2] = pgm_read_byte(&font[(((int)mystring[y])-32)][3]);
        set_y_line_pattern(1, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][4]));  //cube[level][1] = pgm_read_byte(&font[(((int)mystring[y])-32)][4]);
        set_y_line_pattern(0, level, cubesize, pgm_read_byte(&font[(((int)mystring[y])-32)][5]));  //cube[level][0] = pgm_read_byte(&font[(((int)mystring[y])-32)][5]);
        delay_ms(delay);
    }
